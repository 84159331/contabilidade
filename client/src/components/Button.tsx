...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = 'flex items-center justify-center gap-2 font-bold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 touch-manipulation';
