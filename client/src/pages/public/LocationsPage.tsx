  ...
  return (
    <div className="py-16">
      <div className="container mx-auto px-6 text-center">
        ...
        <h1 className="text-4xl font-bold font-heading mb-4">Nossa LocalizaÃ§Ã£o</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-darkest mb-4">
            <strong>EndereÃ§o:</strong> Quadra 38, Ãrea Especial, Lote E, Vila SÃ£o JosÃ©, BrasÃ­lia - DF, 72010-010
          </p>
          <p className="text-gray-darkest mb-4">
