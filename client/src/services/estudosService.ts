...
const estudosDatabase: Estudo[] = [
  ...
  },
  {
    ...
    reflexao: "A fé verdadeira não é apenas acreditar que Deus pode fazer algo, mas confiar completamente nEle. Quando nossa fé está alinhada com a vontade de Deus, milagres acontecem. A fé remove obstáculos e abre caminhos impossíveis. Ã‰ através da fé que vemos o invisível e alcançamos o impossível.",
  ...
  },
  {
    ...
    reflexao: "A paz de Deus é diferente da paz do mundo. Enquanto a paz do mundo depende das circunstâncias, a paz de Deus é independente delas. Ã‰ uma paz que guarda nossos corações e mentes, mesmo em meio às tempestades da vida. Esta paz só pode ser encontrada em Cristo Jesus.",
  ...
  },
  {
    ...
    reflexao: "A esperança cristã não é uma ilusão ou um desejo vago, mas uma certeza baseada nas promessas de Deus. Ã‰ uma esperança que nos enche de gozo e paz, mesmo quando as circunstâncias são difíceis. Esta esperança vem do Espírito Santo e nos sustenta em todos os momentos.",
  ...
  },
  {
    ...
    reflexao: "A transformação cristã é um processo contínuo que acontece através do Espírito Santo. Ã€ medida que contemplamos a glória do Senhor, somos transformados à Sua imagem. Esta transformação não é apenas externa, mas principalmente interna, moldando nosso caráter e nosso coração.",
  ...
  },
  {
    ...
    reflexao: "O amor de Deus é eterno e nunca falha. Enquanto outras coisas podem passar, o amor permanece para sempre. Este amor nos capacita a amar outros de forma incondicional, mesmo quando é difícil. Ã‰ através do amor que demonstramos o caráter de Cristo ao mundo.",
