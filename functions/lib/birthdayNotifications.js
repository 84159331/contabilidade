...
exports.testBirthdayCheck = exports.checkBirthdays = void 0;
...
exports.checkBirthdays = functions.pubsub
    ...
    try {
        ...
        const weekOnlyBirthdays = weekBirthdays.filter(member => !todayBirthdays.some(todayMember => todayMember.id === member.id));
        ...
        // Enviar notificações
        const emailSent = await (0, emailService_1.sendBirthdayEmail)(notificationData);
        const whatsappSent = await (0, whatsAppService_1.sendBirthdayWhatsApp)(notificationData);
 ...
 */
exports.testBirthdayCheck = functions.https.onRequest(async (req, res) => {
    try {
